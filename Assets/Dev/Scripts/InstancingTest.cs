...
public class InstancingTest : MonoBehaviour {
    ...
    void Update() {
        ...
        Graphics.DrawMeshInstancedIndirect(
            instanceMesh, subMeshIndex, instanceMaterial, new Bounds(Vector3.zero, new Vector3(100.0f, 100.0f, 100.0f)), 
            argsBuffer, 0, null as MaterialPropertyBlock, UnityEngine.Rendering.ShadowCastingMode.On, true);
    }
    ...
    void UpdateBuffers() {
        ...
        for (int i = 0; i < instanceCount; i++) {
            ...
            float distance = Random.Range(2.0f, 10.0f);
